...
OculusTouchSteamLink::TrackerDevice::TrackerDevice(std::string serial):
    serial_(serial)
{
}

std::string OculusTouchSteamLink::TrackerDevice::GetSerial()
{
    return this->serial_;
}

void OculusTouchSteamLink::TrackerDevice::Update()
{
...
DeviceType OculusTouchSteamLink::TrackerDevice::GetDeviceType()
{
    return DeviceType::TRACKER;
}

vr::TrackedDeviceIndex_t OculusTouchSteamLink::TrackerDevice::GetDeviceIndex()
{
...
vr::EVRInitError OculusTouchSteamLink::TrackerDevice::Activate(uint32_t unObjectId)
{
...
void OculusTouchSteamLink::TrackerDevice::Deactivate()
{
    this->device_index_ = vr::k_unTrackedDeviceIndexInvalid;
}

void OculusTouchSteamLink::TrackerDevice::EnterStandby()
{
}

void* OculusTouchSteamLink::TrackerDevice::GetComponent(const char* pchComponentNameAndVersion)
{
    return nullptr;
}

void OculusTouchSteamLink::TrackerDevice::DebugRequest(const char* pchRequest, char* pchResponseBuffer, uint32_t unResponseBufferSize)
{
    if (unResponseBufferSize >= 1)
        pchResponseBuffer[0] = 0;
}

vr::DriverPose_t OculusTouchSteamLink::TrackerDevice::GetPose()
{
    return last_pose_;
}
